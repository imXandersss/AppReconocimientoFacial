...
namespace Prueba2Reconocimiento
{
    ...
    public partial class ReconocimientoFacial : Form
    {
        ...
        public static List<int> PersonsLabes = new List<int>();
                    ...
                    if (faces.Length > 0)
                    {
                        ...
                        foreach (var face in faces)
                        {
                            ...
                            if (EnableSaveImage)
                            {
                                ...
                                string path = Directory.GetCurrentDirectory() + @"\ImagenesNuevas";
        ...
        private void btnDetectedFaces_Click(object sender, EventArgs e)
        {
        ...
        private void btnDetectedFaces_Click_1(object sender, EventArgs e)
        {
